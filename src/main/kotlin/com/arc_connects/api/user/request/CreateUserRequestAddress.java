...
@Schema(name = "CreateUserRequest_address", description = "住所情報")
...
public class CreateUserRequestAddress {
  ...
  public CreateUserRequestAddress postalCode(String postalCode) {
  ...
  public CreateUserRequestAddress prefecture(String prefecture) {
  ...
  public CreateUserRequestAddress city(String city) {
    this.city = city;
    return this;
  }
  ...
  public CreateUserRequestAddress addressLine(String addressLine) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.postalCode, createUserRequestAddress.postalCode) &&
        Objects.equals(this.prefecture, createUserRequestAddress.prefecture) &&
        Objects.equals(this.city, createUserRequestAddress.city) &&
        Objects.equals(this.addressLine, createUserRequestAddress.addressLine);
  }
