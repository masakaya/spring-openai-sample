...
public class ErrorResponse {
  ...
  @Schema(name = "error", example = "Invalid request format", description = "Error message", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
  @JsonProperty("error")
  ...
  @Schema(name = "path", example = "/api/chat", description = "Request path that caused the error", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
  @JsonProperty("path")
  ...
  @Override
  public int hashCode() {
    return Objects.hash(error, timestamp, path);
  }
